...
public class TestLaunchBirds extends AbstractTest {
	...
	public void setup() {
		version = DDConfig.getSingleton().getData().getInt("prod.version", 1);
		// Assert.assertTrue(version > 0,
		// "Version should be a greaterthan zero.");
		log.info("############################");
	...
	public String getTestName() {
		return data != null ? data.getString(TAG_TESTID_ATTR) : getClass()
				.getName() + random.nextInt();
	}
}
